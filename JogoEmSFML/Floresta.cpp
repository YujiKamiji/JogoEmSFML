...
namespace Fases {
	...
	void Floresta::inicializar() {
		...
		Chao* chao3 = new Chao(sf::Vector2f(5300, 470), sf::Vector2f(3600, 120));
		...
		Shogun* s = new Shogun(sf::Vector2f(5500, 300), sf::Vector2f(50.0, 100.0), p1, p2);
		...
		entidades.adicionar(s);
		entidades.adicionar(s->getAtaque());
